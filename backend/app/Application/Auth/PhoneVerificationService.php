...
final class PhoneVerificationService
{
    ...
    /**
     * Create or update customer by phone, store verification code, send SMS.
     * Throttles by phone. Returns the customer (existing or new).
     *
     * @return array{success: bool, message: string, customer?: Customer}
     */
    public function sendCode(string $phone, ?string $firstName = null, ?string $lastName = null, ?string $email = null): array
    {
        ...
        return ['success' => true, 'message' => 'Verification code sent.', 'customer' => $customer];
    }
