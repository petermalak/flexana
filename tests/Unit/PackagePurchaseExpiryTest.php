...
class PackagePurchaseExpiryTest extends TestCase
{
    ...
    {
        $bizTz = 'Africa/Cairo';
        $expiresAt = Carbon::parse('2026-06-30', $bizTz)->startOfDay();
        $sessionDate = Carbon::parse('2026-06-30 18:00:00', $bizTz);
    ...
    public function test_does_not_cover_session_date_after_expiry(): void
    {
        $bizTz = 'Africa/Cairo';
        $expiresAt = Carbon::parse('2026-06-30', $bizTz)->startOfDay();
        $sessionDate = Carbon::parse('2026-07-05 10:00:00', $bizTz);
